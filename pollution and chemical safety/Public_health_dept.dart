        ...
        child: Column(
          ...
          children: [
            OptionButton(
              text: 'Accident Areas',
              onPressed: () async {
                List<dynamic> accidentLocations = await fetchLocations('accident');
                Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) => MapScreen(locations: accidentLocations)),
                );
              },
            ),
            OptionButton(
              ...
              onPressed: () async {
                List<dynamic> publicHealthLocations = await fetchLocations('public_health');
                Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) => MapScreen(locations: publicHealthLocations)),
                );
              },
            ),
          ],
