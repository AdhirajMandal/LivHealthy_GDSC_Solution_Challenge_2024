        ...
        child: Column(
          ...
          children: [
            OptionButton(
              text: 'Accident Zones',
              onPressed: () async {
                List<dynamic> accidentZones = await fetchLocations('accident_zone');
                Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) => MapScreen(locations: accidentZones)),
                );
              },
            ),
            OptionButton(
              ...
              onPressed: () async {
                List<dynamic> urgentCareCenters = await fetchLocations('urgent_care');
                Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) => MapScreen(locations: urgentCareCenters)),
                );
              },
            ),
          ],
